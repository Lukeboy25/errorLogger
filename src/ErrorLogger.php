<?php namespace ErrorLogger;

use Exception;

use ErrorLogger\Helpers\Logger;
...
class ErrorLogger
{
    ...
    {
        return 'errorlogger.' . str_slug($data['host'] . '_' . $data['method'] . '_' . $data['exception'] . '_' . $data['line'] . '_' . $data['file'] . '_' . $data['class']);
    }
